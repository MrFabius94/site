...
const bundle=Cookies.get('bundleVersion')||null;const suffix=bundle?`-${bundle.replace(/\d/g,'')}`:'';window.location.href=`https://launcher.storage.nextrp.ru/releases/nextrp-launcher${suffix}.exe`}
